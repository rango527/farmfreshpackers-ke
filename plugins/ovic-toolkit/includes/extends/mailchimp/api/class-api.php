...
if ( !class_exists( 'OVIC_API' ) ) {
	class OVIC_API
	{
		...
		{
			$message .= '<br /><br />' . sprintf( '<a href="%s">' . __( 'Read more about common connectivity issues.', 'mailchimp-for-wp' ) . '</a>', 'https://kb.ovic.com/solving-connectivity-issues/#utm_source=wp-plugin&utm_medium=mailchimp-for-wp&utm_campaign=settings-notice' );
		...
		private function get_headers()
		{
			...
			$headers = array(
				...
				'User-Agent' => 'ovic/' . OVIC_TOOLKIT_VERSION . '; WordPress/' . $wp_version . '; ' . get_bloginfo( 'url' ),
			);
