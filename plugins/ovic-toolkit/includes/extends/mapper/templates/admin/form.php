...
$settings = get_post_meta( $post->ID, 'ovic_mapper_settings', true );
// Get all pins.
$pins = get_post_meta( $post->ID, 'ovic_mapper_pins', true );
?>
<script type="text/html" id="ovic_mapper_change_tmpl">
    <div class="tabs-ovic-mapper">
        <a href="#" class="change-editor active" data-show=".ovic-mapper-wrap"
           data-hide="#postdivrich,.composer-switch,#wpb_visual_composer">
			<?php _e( 'PIN MAP', 'ovic-toolkit' ); ?>
        </a>
        <a href="#" class="change-editor" data-show="#postdivrich,.composer-switch,#wpb_visual_composer"
           data-hide=".ovic-mapper-wrap">
			<?php _e( 'EDITOR', 'ovic-toolkit' ); ?>
        </a>
    </div>
</script>
<script type="text/html" id="ovic_mapper_tmpl">
    <div class="ovic-mapper-wrap" style="position: relative;z-index: 999">
        <div class="ovic-mapper bdgr bgw">
            <div class="ovic-mapper-mid fc aic jcsb pd__20 bggr">
                <div class="global-setting fc aic">
                    <div id="general-settings">
                        <a href="javascript:void(0)" class="btn br__3 dib">
                            <span class="dashicons dashicons-admin-generic"></span>
							<?php _e( 'General Settings', 'ovic-toolkit' ); ?>
                        </a>
                        ...
                        <div class="setting-box general-setting br__3 bgw bdgr">
                            ...
                            <ul class="nav mg__0 fc">
                                <li data-nav="style"
                                    class="mg__0 active"><?php _e( 'Style Settings', 'ovic-toolkit' ); ?></li>
                                <!-- <li data-nav="image-effect" class="mg__0"><?php _e( 'Image Effect', 'ovic-toolkit' ); ?></li> -->
                            </ul>

                            <div class="tab-content">
                                <div data-tab="style" class="tab-item">
                                    <label class="db mb__10"><?php _e( 'Popup size', 'ovic-toolkit' ); ?></label>
                                    <div class="row mb__25">
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e( 'Width', 'ovic-toolkit' ); ?></label>
                                        ...
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e( 'Height', 'ovic-toolkit' ); ?></label>
                                            <div class="input-unit pr">
                                    ...
                                    <div class="row">
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e( 'Tooltip style', 'ovic-toolkit' ); ?></label>
                                            <div class="select-styled pr">
                                                <select name="tooltip-style" class="slt select-large">
                                                    <option value="light"><?php _e( 'Light', 'ovic-toolkit' ); ?></option>
                                                    <option value="dark"><?php _e( 'Dark', 'ovic-toolkit' ); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e( 'Popup box shadow', 'ovic-toolkit' ); ?></label>
                                        ...
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e( 'Popup show fffect', 'ovic-toolkit' ); ?></label>
                                            <div class="select-styled pr">
                                                <select name="popup-show-effect" class="slt select-large">
                                                    <option value=""><?php _e( 'None', 'ovic-toolkit' ); ?></option>
                                                    <option value="fade"><?php _e( 'Fade In', 'ovic-toolkit' ); ?></option>
                                                    <option value="slide-left"><?php _e( 'Slide From Left', 'ovic-toolkit' ); ?></option>
                                                    <option value="slide-right"><?php _e( 'Slide From Right', 'ovic-toolkit' ); ?></option>
                                                    <option value="slide-top"><?php _e( 'Slide From Top', 'ovic-toolkit' ); ?></option>
                                                    <option value="slide-bottom"><?php _e( 'Slide From Bottom', 'ovic-toolkit' ); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e( 'Popup border radius', 'ovic-toolkit' ); ?></label>
                                            <div class="input-unit pr">
                                        ...
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e( 'Popup border width', 'ovic-toolkit' ); ?></label>
                                            <div class="input-unit pr">
                                        ...
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e( 'Popup border color', 'ovic-toolkit' ); ?></label>
                                    ...
                                    <div class="row">
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e( 'Image effect', 'ovic-toolkit' ); ?></label>
                                            <div class="select-styled pr">
                                                <select name="image-effect" class="slt select-large">
                                                    <option value="none"><?php _e( 'None', 'ovic-toolkit' ); ?></option>
                                                    <option value="blur"><?php _e( 'Blur', 'ovic-toolkit' ); ?></option>
                                                    <option value="gray"><?php _e( 'Gray', 'ovic-toolkit' ); ?></option>
                                                    <option value="mask"><?php _e( 'Mask Overlay', 'ovic-toolkit' ); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="cm-4" data-image-effect="mask">
                                            <label class="db mb__10"><?php _e( 'Mask color', 'ovic-toolkit' ); ?></label>
                                            <div class="picker-styled pr">
                    ...
                    <div class="ovic-copy-shortcode">
                        <span class="shortcode-name"><?php echo esc_html__( 'Copy Shortcode', 'ovic-toolkit' ) ?></span>
                        <input id="shortcode-syntax" class="shortcode-syntax"
                               value='[ovic_mapper id="<?php echo absint( $post->ID ); ?>"]'>
                    </div>
                </div>
            </div><!-- .ovic-mapper-mid -->

            <div class="ovic-mapper-bot pr aic fc jcc <?php if ( $attachment_id ) echo 'pr'; ?>">
                <input type="hidden" id="ovic_mapper_image" name="ovic_mapper_image"
                       value="<?php echo absint( $attachment_id ); ?>">

				<?php if ( $attachment_id ) : ?>
                    <div class="edit-image pr">
                        <a id="change-image" href="#" class="btn-change-image pa db br__3">
                            <i class="wricon-camera mr__5"></i><?php _e( 'Change Image', 'ovic-toolkit' ); ?>
                        </a>
				...
				<?php else : ?>
                    <div class="add-image">
                        ...
                        <span class="empty-mapper"><?php _e( 'Add your image mapping', 'ovic-toolkit' ); ?></span>
                    </div>
				<?php endif; ?>
            </div><!-- .ovic-mapper-bot -->
        </div><!-- .ovic-mapper -->
...
<script type="text/html" id="ovic_mapper_image_tmpl">
    <div class="edit-image pr">
        <a id="change-image" href="#" class="btn-change-image pa db br__3">
            <i class="fa fa-camera-retro mr__5" aria-hidden="true"></i><?php _e( 'Change Image', 'ovic-toolkit' ); ?>
        </a>
...
<script type="text/html" id="ovic_mapper_pin_tmpl">
    ...
    <div class="setting-box pin-setting br__3 bgw bdgr">
        <h4 class="mg__0 pr">
			<?php _e( 'Pin Settings', 'ovic-toolkit' ); ?>
            <i class="close-box pa">x</i>
        </h4>
        ...
        <ul class="nav mg__0 fc">
            <li data-nav="general" class="mg__0 active"><?php _e( 'General', 'ovic-toolkit' ); ?></li>
            <li data-nav="icon-settings" class="mg__0"><?php _e( 'Icon Settings', 'ovic-toolkit' ); ?></li>
            <li data-nav="popup-settings" class="mg__0"><?php _e( 'Popup Settings', 'ovic-toolkit' ); ?></li>
        </ul>
        ...
        <div class="tab-content">
            <div data-tab="general" class="tab-item">
                <div class="radio-group fc mb__25">
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <span></span>
							<?php _e( 'WooCommerce', 'ovic-toolkit' ); ?>
                        </label>
                    </div>
                    <div class="item-styled">
                        <label class="pr">
                ...
                <div class="form-input mb__25" data-pin-type="woocommerce">
                    <label class="db mb__10"><?php _e( 'Select product', 'ovic-toolkit' ); ?></label>
                    ...
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <input type="checkbox" onchange="jQuery(this).prev().val(this.checked ? 1 : 0);"
                                   checked="checked">
                            <span></span>
							<?php _e( 'Show thumbnail', 'ovic-toolkit' ); ?>
                        </label>
                    </div>
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <input type="checkbox" onchange="jQuery(this).prev().val(this.checked ? 1 : 0);"
                                   checked="checked">
                            <span></span>
							<?php _e( 'Show description', 'ovic-toolkit' ); ?>
                        </label>
                    </div>
                    <div class="item-styled">
                        <label class="pr">
                ...
                <div class="form-input mb__25" data-pin-type="image|text|link">
                    <label class="db mb__10"><?php _e( 'Popup title', 'ovic-toolkit' ); ?></label>
                    <input type="text" data-option="settings[popup-title]" class="input-text input-large" value=""
                           placeholder="<?php
						   _e( 'Input a title for the popup here...', 'ovic-toolkit' );
						   ?>">
                </div>

                <!-- Image Settings -->
                <div class="input-group mb__25" data-pin-type="image">
                    <label class="db mb__10"><?php _e( 'Select image', 'ovic-toolkit' ); ?></label>
                    <div class="pr">
                ...
                <div class="row mb__25" data-pin-type="image|link">
                    <div class="cm-7">
                        <div class="form-input">
                            <label class="db mb__10"><?php _e( 'Link To', 'ovic-toolkit' ); ?></label>
                            <input type="text" data-option="settings[image-link-to]" class="input-text input-large"
                                   value="">
                        </div>
                    </div>
                    <div class="cm-5">
                        <label class="db mb__10"><?php _e( 'Target', 'ovic-toolkit' ); ?></label>
                        <div class="select-styled pr">
                            <select data-option="settings[image-link-target]" class="slt select-large">
                                <option value="_self"><?php _e( 'Default', 'ovic-toolkit' ); ?></option>
                                <option value="_blank"><?php _e( 'New Tab', 'ovic-toolkit' ); ?></option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-input" data-pin-type="text">
                    <label class="db mb__10"><?php _e( 'Text Content', 'ovic-toolkit' ); ?></label>
                    <textarea data-option="settings[text]" rows="6" placeholder="<?php
					_e( 'Input some content for the popup here...', 'ovic-toolkit' );
					?>"></textarea>
                </div>
                <!-- End Text Settings -->
            </div>
                ...
                <div data-icon-type="icon-area">
                    <div class="row mb__20">
                        <div class="cm-4 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Text', 'ovic-toolkit' ); ?></label>
                            <input type="text" data-option="settings[area-text]"
                                   class="text-custom input-text input-large" value="">
                        </div>
                        <div class="cm-4 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Font Size', 'ovic-toolkit' ); ?></label>
                            <div class="input input--number pr">
                                <input type="number" data-option="settings[area-text-size]"
                                       class="input-text input-large" value="13">
                            </div>
                        </div>
                        <div class="cm-4 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Text Color', 'ovic-toolkit' ); ?></label>
                            <div class="picker-styled pr">
                    ...
                    <div class="row mb--20">
                        <div class="cm-3 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Width', 'ovic-toolkit' ); ?></label>
                            <div class="input input--number pr">
                                <input type="number" data-option="settings[area-width]" class="input-text input-large"
                                       value="32">
                            </div>
                        </div>
                        <div class="cm-3 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Height', 'ovic-toolkit' ); ?></label>
                            <div class="input input--number pr">
                                <input type="number" data-option="settings[area-height]" class="input-text input-large"
                                       value="32">
                            </div>
                        </div>
                        <div class="cm-3 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Border Width', 'ovic-toolkit' ); ?></label>
                            <div class="input input--number pr">
                        ...
                        <div class="cm-3 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Border Radius', 'ovic-toolkit' ); ?></label>
                            <div class="input input--number pr">
                                <input type="number" data-option="settings[area-border-radius]"
                                       class="input-text input-large" value="50">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="cm-6 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Background', 'ovic-toolkit' ); ?></label>
                            <div class="picker-styled pr">
                                <input type="text" data-option="settings[area-bg-color]" class="w__150 color-picker"
                                       data-default-color="rgba(101, 175, 250, .5)" value="rgba(101, 175, 250, .5)">
                            </div>
                        </div>
                        <div class="cm-6 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Border Color', 'ovic-toolkit' ); ?></label>
                            <div class="picker-styled pr">
                                <input type="text" data-option="settings[area-border-color]" class="w__150 color-picker"
                                       data-default-color="rgba(0, 0, 0, .5)" value="rgba(0, 0, 0, .5)">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div data-tab="popup-settings" class="tab-item hidden">
                <label class="db mb__10"><?php _e( 'Custom popup size', 'ovic-toolkit' ); ?></label>
                <div class="row">
                    <div class="cm-4">
                        <label class="db mb__10"><?php _e( 'Width', 'ovic-toolkit' ); ?></label>
                        <div class="input-unit pr">
                    ...
                    <div class="cm-4">
                        <label class="db mb__10"><?php _e( 'Position', 'ovic-toolkit' ); ?></label>
                        <div class="select-styled pr">
                            <select data-option="settings[popup-position]" class="slt select-large">
                                <option value="right"><?php _e( 'Right', 'ovic-toolkit' ); ?></option>
                                <option value="left"><?php _e( 'Left', 'ovic-toolkit' ); ?></option>
                                <option value="top"><?php _e( 'Top', 'ovic-toolkit' ); ?></option>
                                <option value="bottom"><?php _e( 'Bottom', 'ovic-toolkit' ); ?></option>
                            </select>
                        </div>
                    </div>
                </div>
...
?>
<script type="text/html" id="ovic_mapper_icon_selector_tmpl">
    <div class="icon-selector select-styled pr bdgr br__3">
        ...
        <div class="icon-wrap pa bdgr">
            <h5><?php _e( 'Select icon', 'ovic-toolkit' ); ?><i class="close fa fa-close"></i></h5>
...
<script type="text/javascript">
    jQuery(function ($) {
        $(document).ready(function () {
            // Override default UI.
            var form   = $($('#ovic_mapper_tmpl').text()).prepend($('#post').children('input[type="hidden"]')),
                editor = $('#ovic_mapper_change_tmpl').text();

            $('#screen-meta, #screen-meta-links,#edit-slug-box').remove();

            $('#post-body > div#post-body-content #titlediv').after(form).before(editor);

            $('.tabs-ovic-mapper .change-editor').on('click', function () {
                var _this    = $(this),
                    _show    = _this.data('show'),
                    _hide    = _this.data('hide'),
                    _content = _this.closest('#post-body');

                _content.find(_show).show();
                _content.find(_hide).hide();
            ...
            setTimeout(function () {
                $(document).trigger('init_ovic_mapper');
            }, 500);

            // Pass data to client-side.
            window.ovic_mapper_settings = <?php echo json_encode( $settings ? $settings : new stdClass() ); ?>;
            window.ovic_mapper_pins     = <?php echo json_encode( $pins ? array_values( $pins ) : array() ); ?>;
        });
    });
</script>
