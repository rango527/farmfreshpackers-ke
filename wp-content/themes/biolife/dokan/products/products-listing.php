...
<div class="dokan-dashboard-wrap" style="margin-top: 30px; margin-bottom: 30px;">
                        ...
                        <span class="dokan-add-product-link">
                            <?php if ( current_user_can( 'dokan_add_product' ) ): ?>
                                <a href="<?php echo esc_url( dokan_get_navigation_url( 'new-product' ) ); ?>" class="dokan-btn dokan-btn-theme <?php echo ( 'on' == dokan_get_option( 'disable_product_popup', 'dokan_selling', 'off' ) ) ? '' : 'dokan-add-new-product'; ?>">
                                    ...
                                    <?php esc_html_e( 'Add new product', 'biolife' ); ?>
                                </a>
                            <?php endif ?>
                ...
                <div class="dokan-dashboard-product-listing-wrapper">
                    ...
                    <form id="product-filter" method="POST" class="dokan-form-inline">
                        <div class="dokan-form-group">
                            <label for="bulk-product-action-selector" class="screen-reader-text"><?php esc_html_e( 'Select bulk action', 'biolife' ); ?></label>
                        ...
                        <div class="dokan-form-group">
                            ...
                            <input type="submit" name="bulk_product_status_change" id="bulk-product-action" class="dokan-btn dokan-btn-theme" value="<?php esc_attr_e( 'Apply', 'biolife' ); ?>">
                        </div>
                        <table class="dokan-table dokan-table-striped product-listing-table dokan-inline-editable-table" id="dokan-product-list-table">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php esc_html_e( 'Image', 'biolife' ); ?></th>
                                    <th><?php esc_html_e( 'Name', 'biolife' ); ?></th>
                                    <th><?php esc_html_e( 'Status', 'biolife' ); ?></th>

                                    <?php do_action( 'dokan_product_list_table_after_status_table_header' ); ?>

                                    <th><?php esc_html_e( 'SKU', 'biolife' ); ?></th>
                                    <th><?php esc_html_e( 'Stock', 'biolife' ); ?></th>
                                    <th><?php esc_html_e( 'Price', 'biolife' ); ?></th>
                                    <th><?php esc_html_e( 'Earning', 'biolife' ); ?></th>
                                    <th><?php esc_html_e( 'Type', 'biolife' ); ?></th>
                                    <th><?php esc_html_e( 'Views', 'biolife' ); ?></th>
                                    <th><?php esc_html_e( 'Date', 'biolife' ); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                ...
                                ?>
                                    <tr>
                                        <td colspan="7"><?php esc_html_e( 'No product found', 'biolife' ); ?></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                    ...
                    if ( $product_query->max_num_pages > 1 ) {
                        ...
                        $page_links = paginate_links( array(
                            ...
                            'add_args'  => false,
                            'type'      => 'array',
                            'prev_text' => __( '&laquo; Previous', 'biolife' ),
                            'next_text' => __( 'Next &raquo;', 'biolife' )
                        ) );
