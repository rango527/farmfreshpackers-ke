		...
		<form name="f" method="post" action="">
			...
			<div class="mo_firebase_auth_card" style="width:100%">
				...
				<!-- <div id="toggle1" class="mo_panel_toggle"> -->
					<p style="font-size: 18px">Login with miniOrange</p>
				<!-- </div> -->
				<p style="font-size: 12px"><b>It seems you already have an account with miniOrange. Please enter your miniOrange email and password.<br/> <a href="#mo_firebase_authentication_forgot_password_link">Click here if you forgot your password?</a></b>
				</p>
				...
				<!-- <div id="panel1"> -->
					<table class="mo_settings_table">
						...
						<br>
						<div>
							<input style="margin-left:17%;width:16%" type="submit" name="submit" value="Login"
