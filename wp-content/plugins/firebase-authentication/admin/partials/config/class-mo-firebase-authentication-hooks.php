	...
	class Mo_Firebase_Authentication_Admin_Hooks {
		...
		<div class="col-md-12">
			<div class="mo_firebase_auth_card" style="width:90%">
		    	We provide multiple hooks to extend the plugin functionality. <small style="color: #FF0000"><a href="admin.php?page=mo_firebase_authentication&tab=licensing_plans">[PREMIUM]</a></small><br><br>
