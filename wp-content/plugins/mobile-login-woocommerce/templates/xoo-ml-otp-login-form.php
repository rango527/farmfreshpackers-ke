...
<button type="button" class="xoo-ml-open-lwo-btn button btn <?php echo implode( ' ', $args['button_class'] ); ?> "><?php _e( 'Login with OTP', 'mobile-login-woocommerce' ); ?></button>
...
<div class="xoo-ml-lwo-form-placeholder" <?php if( $args['login_first'] !== 'yes' ): ?> style="display: none;" <?php endif; ?> >
	...
	<button type="submit" class="xoo-ml-login-otp-btn <?php echo implode( ' ', $args['button_class'] ); ?> "><?php _e( 'Login with OTP', 'mobile-login-woocommerce' ); ?></button>

	<span class="xoo-ml-or"><?php _e( 'Or', 'mobile-login-woocommerce' ); ?></span>

	<button type="button" class="xoo-ml-low-back <?php echo implode( ' ', $args['button_class'] ); ?>"><?php _e( 'Login with Email & Password', 'mobile-login-woocommerce' ); ?></button>
