...
(function (factory) {
    ...
    Slick.prototype.getLeft = function (slideIndex) {
        ...
        slideWidth     = (_.listWidth - (_.options.slidesToShow - 1) * _.options.slidesMargin) / _.options.slidesToShow + _.options.slidesMargin;
        ...
        if ( _.options.centerMode === true && _.slideCount > _.options.slidesToShow ) {
            if ( _.options.centerMode === true && _.options.infinite === true ) {
                if ( _.options.slidesToShow === 2 ) {
                    _.slideOffset -= slideWidth * Math.abs(1 / 2);
                } else {
                    _.slideOffset += slideWidth * Math.abs((_.options.slidesToShow - 3) / 2);
                }
            } else if ( _.options.centerMode === true ) {
                _.slideOffset += slideWidth * Math.abs((_.options.slidesToShow - 1) / 2);
            }
        }
    ...
    Slick.prototype.getSlideCount = function () {
        ...
        var _ = this,
            slidesTraversed, slidesLast, swipedSlide, centerOffset;
        ...
        if ( _.options.swipeToSlide === true ) {
            ...
            slidesTraversed = Math.abs($(swipedSlide).data('slick-index') - _.currentSlide) || 1;
            slidesLast      = Math.abs($(swipedSlide).data('slick-index')) + 1;

            if ( slidesLast + slidesTraversed >= _.slideCount && _.options.infinite === false && _.options.centerMode === false ) {
                slidesTraversed = Math.abs(_.slideCount - slidesLast) || 1;
            }
    ...
    Slick.prototype.setDimensions = function () {
        ...
        if ( _.options.vertical === false && _.options.variableWidth === false ) {
            _widthMargin = Math.abs(_valueMargin / _.options.slidesToShow);
    ...
    Slick.prototype.setSlideClasses = function (index) {
        ...
        var _ = this,
            centerOffset, allSlides, indexOffset, remainder, MarginRtl;
