...
//     $rave_settings_url = esc_url( admin_url( null, 'admin.php?page=wc-settings&tab=checkout&section=rave' ) );
...
function flw_plugin_action_links( $links ) {
  $plugin_links = array(
    '<a href="' . admin_url( 'admin.php?page=wc-settings&tab=checkout&section=rave' ) . '">' . __( 'Settings', 'flw_plugin' ) . '</a>',
  );
