...
if ( !class_exists( 'Ovic_Import_Demo_Content' ) ) {
	class Ovic_Import_Demo_Content
	{
		...
		function woocommerce_attributes()
		{
			return array(
               array(
                   'attribute_name'	    =>'bottle-size',
                   'attribute_label'	    =>'Bottle Size',
               ...
               array(
                   'attribute_name'	    =>'fresh-fruits',
                   'attribute_label'	    =>'Fresh Fruits',
                   'attribute_type'	    =>'select',
                   'attribute_orderby'    =>'menu_order',
                   'attribute_public'	    =>'0',
               ),
		...
		function import_config( $data_filter )
		{
			$registed_menu                = array(
               ...
               'top_menu_header_11' => 'Top Menu Header 11',
               'top_right_menu_header_12' => 'Top Right Menu Header 12',
               'top_left_menu_header_12' => 'Top Left Menu Header 12',
               'language_menu' => 'Menu Language',
               'top_left_menu_header_13' => 'Top Left Menu Header 13',
               'top_right_menu_header_13' => 'Top Right Menu Header 13', );
			$menu_location                = array(
               'primary' => 'Primary Menu',
               'top_left_menu' => 'Top Left Menu',
               'top_right_menu' => 'Top Right Menu',
			...
			$data_filter['data_import']   = array(
				'main_demo'      => "https://biolife.kutethemes.net",
			...
			$data_filter['woo_catalog']   = '370';
			$data_filter['woo_ratio']     = '370:370';
					...
					if ( !empty( $items ) ) {
						foreach ( $items as $item ) {
							...
							if ( !empty( $_menu_item_url ) ) {
								$_menu_item_url = str_replace( "https://biolife.kutethemes.net", $home_url, $_menu_item_url );
								$_menu_item_url = str_replace( "http://biolife.kutethemes.net", $home_url, $_menu_item_url );
