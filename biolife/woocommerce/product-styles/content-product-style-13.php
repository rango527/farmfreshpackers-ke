...
?>
<?php
add_action( 'woocommerce_before_shop_loop_item_title', 'biolife_get_categories', 11 );
...
<?php
remove_action( 'woocommerce_before_shop_loop_item_title', 'biolife_get_categories', 11 );
